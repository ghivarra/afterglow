...
var API_CONTABO_AUTH_HOST string
var API_CONTABO_GENERAL_HOST string
...
func LoadServerEnv() {
	...
	API_CONTABO_GENERAL_HOST = os.Getenv("API_CONTABO_GENERAL_HOST")
	API_CONTABO_AUTH_HOST = os.Getenv("API_CONTABO_AUTH_HOST")
}
